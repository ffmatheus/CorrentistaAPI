package com.api.correntista.global;

public class QueryUtils {
	
	public static final String QUERY_GET_ALL_CORRENTISTA = "SELECT * FROM correntista.correntista";

	public static final String QUERY_GET_CORRENTISTA_BY_AG_AND_CONTA = "SELECT * FROM correntista.correntista where ag = %d and conta = %d";
